...
#
# WARNING, this script is only usable for Travis CI - continuous integration, it's not intended to work on other ways.
...
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.infrastructure.connector.dummy-0.1.0-SNAPSHOT.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.infrastructure.connector.dummy" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.platform-0.1.0-SNAPSHOT.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.platform" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.platform.connector.dummy-0.1.0-SNAPSHOT.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.platform.connector.dummy" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
...
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.cloud.connector-0.1.0-SNAPSHOT.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.cloud.connector" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.cloud-0.1.0-SNAPSHOT.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.cloud" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
